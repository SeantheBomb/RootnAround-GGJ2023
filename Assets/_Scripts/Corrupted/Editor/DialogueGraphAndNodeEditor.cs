...
[CustomEditor(typeof(SequenceGraph), true)]
#if ODIN_INSPECTOR
...
public class GlobalGraphEditor : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        //if (GUILayout.Button("Update Tree", GUILayout.Height(40)))
        //{
        //    //DialogueGraph graph = (DialogueGraph)(serializedObject.targetObject);
        //    GraphNode.OnAnyChange();
        //}
